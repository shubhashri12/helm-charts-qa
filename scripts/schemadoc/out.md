...
| Path | Title | Description |
| :---- | :---- | :---- |
| .global.collectorsetServiceNameSuffix |  | Suffix to be added to .Release.name to generate Collectorset controller service URL.<br>Keep it empty while installing this chart individually, umbrella chart uses this to generate unique name across. |
| .global.accessID | Logicmonitor API Token accessID | The LogicMonitor API key ID.<br>NOTE: Ensure to add surrounding double quotes to avoid special character parsing errors. |
| .global.accessKey | Logicmonitor API Token accessKey | The LogicMonitor API key.<br>NOTE: Ensure to add surrounding double quotes to avoid special character parsing errors. |
| .global.account | Logicmonitor account name | The LogicMonitor account name.nValue should be trimmed from URL "___.logicmonitor.com"<br>example: lmqauat.logicmonitor.com then "lmqauat" must be a valid value. |

## .global.imagePullSecrets title
...
| Path | Title | Description |
| :---- | :---- | :---- |
| .global.image.registry | The registry schema | Container Image Registry. |
| .global.image.pullPolicy | pullPolicy | Overrides the image tag whose default is the chart appVersion. |
...
| Path | Title | Description |
| :---- | :---- | :---- |
| .global.proxy.url | url | Proxy service endpoint. |
| .global.proxy.user | The user schema | User for Proxy service. |
| .global.proxy.pass | pass | Password for the Proxy service. |
...
| Path | Title | Description |
| :---- | :---- | :---- |
| .global.collectorsetServiceNameSuffix |  | Suffix to be added to .Release.name to generate Collectorset controller service name.<br>Keep it empty while installing this chart individually, umbrella chart uses this to generate unique name across |
...
| Path | Title | Description |
| :---- | :---- | :---- |
| .global.proxy.url | The url schema | An explanation about the purpose of this instance. |
| .global.proxy.user | The user schema | An explanation about the purpose of this instance. |
| .global.proxy.pass | The pass schema | An explanation about the purpose of this instance. |
